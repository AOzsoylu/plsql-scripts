Rem
Rem $Header: creuserlike.sql 03-apr-2007 $
Rem
...
Rem ===========================================================
Rem Some parts of the script has been changed by Atilla Özsoylu
Rem ===========================================================
...
prompt --------------------------------------------------------------------------------;
prompt Mevcut schema/user benzeri YENÝ schema/user oluþturma.;
prompt Default bilgiler köþeli parantez [] arasýnda verilmiþtir.;
prompt --------------------------------------------------------------------------------;

accept OriginalUser prompt "Mevcut schema/user [%_USER]: " default %_USER
accept NewUser      prompt "Yeni  schema/user [USER001]: " default USER001
accept NewPassword  prompt "Yeni  schema/user password : " hide

prompt ================================================================================;
prompt Aþaðýdaki bilgileri girildi :
prompt ;

prompt Mevcut schema/user : %OriginalUser
prompt Yeni schema/user   : %NewUser

prompt ;
prompt Bilgiler doðru ise ENTER'a basýnýz.;
prompt Doðrý deðilse CTRL+C;
prompt ;
prompt DBA haklarý olan bir user ile çalýþtýrýldýðýna emin olun!;
prompt ================================================================================;
pause
...
prompt --------------------------------------------------------------------------------;
prompt --- %OriginalUser benzeri %NewUser isimli schema/user oluþturma : ;
prompt --- Script içeriðine %v_file_name dosyasýndan ulaþabilirsiniz.
prompt --- Çalýþtýrmak için :
prompt ;
prompt @%v_file_name ;
prompt ;
prompt --- Sonrasýnda script dosyasýný silmeyi unutmayýnýz! ;
prompt ;
prompt host %v_remove_command %v_file_name ;
prompt ;
prompt --------------------------------------------------------------------------------;
